...
public class Dictionary {
	...
	public static final int OPTION_STUDENT_WORD = 1;
	public static final int OPTION_STUDENT_ALPHABET = 2;
		
	
	public static ArrayList<String> makeWordList(int option){
		// option 0: 학생목록, 1: 코딩용어, 2: 랜덤 알파벳
		...
		}else if(option == OPTION_STUDENT_WORD) {
			wordList.add("Class");
			wordList.add("static");
			wordList.add("while");
			wordList.add("for");
		...
		}else if(option == OPTION_STUDENT_ALPHABET) {
			// 랜덤 알파벳 6자리
